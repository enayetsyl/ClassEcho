...
export function NavBar() {
  ...
  const dashboardItems: NavItem[] = [
    ...
    },
    {
      ...
      label: "All Videos",
      roles: ["SeniorAdmin", "Management", "Admin"],
    },
    {
      href: "/dashboard/admin/videos/upload-video",
      label: "Upload Video",
      roles: ["SeniorAdmin", "Management", "Admin"],
    },
    {
    ...
    },
    {
      ...
      label: "Quran Entry",
      roles: ["Admin", "SeniorAdmin", "Teacher"],
    },
    {
    ...
    {
      href: "/dashboard/admin/videos/feedback",
      label: "My Feedback",
      roles: ["Teacher"],
    },
    {
      href: "/dashboard/admin/videos/reviewer",
      label: "To Review",
      roles: ["Teacher"],
    },
  ];
              ...
              <SheetContent side="left" className="p-4 pt-10 bg-navbar-bg">
                ...
                <div className="flex flex-col space-y-4">
                  <Link href="/dashboard/profile">
                    <Button
                      variant={
                        pathname === "/dashboard" ? "default" : "outline"
                      }
