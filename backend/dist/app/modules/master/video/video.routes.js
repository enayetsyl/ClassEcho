...
router.post('/:id/review', auth_middleware_1.requireAuth, (0, auth_middleware_1.requireRole)(['Teacher']), (0, validate_request_1.default)(video_validation_1.submitReviewValidation), video_controller_1.VideoControllers.submitReview);
